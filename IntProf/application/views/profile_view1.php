            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table style="color: white" class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td>Email</td>
                        <td><a style="color: white" href="mailto:info@support.com"><?php echo $email ?></a></td>
                      </tr>
                        <td>Phone Number</td>
                        <td><?php echo $contact ?>
                        </td>   
                  ...
                  <a href="<?php echo site_url("courses")?>" class="btn btn-primary" style="color: white; margin-top: 20px">Ongoing Courses</a>
